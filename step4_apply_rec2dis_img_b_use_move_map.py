...
if(__name__ == "__main__"):
    ...
    ### 拿到 dis_img
    dis_imgs = get_dir_certain_imgs(data_access_path + "step3_apply_flow_h=384,w=256_complex+page", "3a1-I1-patch")
    dis_img = dis_imgs[0]
    ### 拿到 move_map
    moves = get_dir_certain_moves(data_access_path + "step3_apply_flow_h=384,w=256_complex+page", "2-q")
    move_map = moves[0]
    proc_move_map = move_map.copy()
