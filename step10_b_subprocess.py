...
compress_all  = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=0, see_amount=7, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
compress_1    = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=0, see_amount=1, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
compress_2    = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=1, see_amount=1, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
compress_3    = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=2, see_amount=1, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
compress_4    = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=3, see_amount=1, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
compress_8    = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=4, see_amount=1, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
compress_9    = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=5, see_amount=1, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
compress_10   = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=6, see_amount=1, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"

compress_2te  = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=1, see_amount=6, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
compress_3te  = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=2, see_amount=5, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
compress_4te  = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=3, see_amount=4, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
compress_8te  = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=4, see_amount=3, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
compress_9te  = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=5, see_amount=2, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
compress_10te = f"build().result_obj.save_multiple_single_see_as_matplot_bm_rec_visual(start_see=6, see_amount=1, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={bm_rec_print_msg}, see_core_amount={see_core_amount})"
...
calculate_all  = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=0, see_amount=7, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
calculate_1    = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=0, see_amount=1, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
calculate_2    = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=1, see_amount=1, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
calculate_3    = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=2, see_amount=1, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
calculate_4    = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=3, see_amount=1, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
calculate_8    = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=4, see_amount=1, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
calculate_9    = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=5, see_amount=1, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
calculate_10   = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=6, see_amount=1, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"

calculate_2te  = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=1, see_amount=6, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
calculate_3te  = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=2, see_amount=5, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
calculate_4te  = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=3, see_amount=4, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
calculate_8te  = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=4, see_amount=3, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
calculate_9te  = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=5, see_amount=2, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
calculate_10te = f"build().result_obj.calculate_multiple_single_see_SSIM_LD(start_see=6, see_amount=1, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount={single_see_core_amount}, print_msg={calculate_print_msg}, see_core_amount={see_core_amount})"
...
##########################################################################################################################################################################################
##########################################################################################################################################################################################
# sb.run(same_command + [f"testest.{calculate_all}"])   ### 127.28
