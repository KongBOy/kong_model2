...
# sb.run(same_command + [f"epoch700_bn_see_arg_T_no_down .{Calculate_and_Visual_SSIM_LD_all}"])  ### 看看 lr 都不下降的效果
...
##########################################################################################################################################################################################
### 4. epoch
# sb.run(same_command + [f"ch64_in_epoch060.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch080.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch100.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN

# sb.run(same_command + [f"ch64_in_epoch200.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN

# sb.run(same_command + [f"ch64_in_epoch220.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch240.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch260.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch280.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch300.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN

# sb.run(same_command + [f"ch64_in_epoch320.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch340.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch360.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch380.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch400.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN

# sb.run(same_command + [f"ch64_in_epoch420.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch440.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch460.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch480.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_epoch500.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN

# sb.run(same_command + [f"ch64_in_epoch700.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN

### 4b.
# sb.run(same_command + [f"in_new_ch004_ep060.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"in_new_ch008_ep060.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"in_new_ch016_ep060.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"in_new_ch032_ep060.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"in_new_ch128_ep060.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN

# sb.run(same_command + [f"in_new_ch004_ep100.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"in_new_ch008_ep100.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"in_new_ch016_ep100.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"in_new_ch032_ep100.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"in_new_ch128_ep100.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN

##########################################################################################################################################################################################
### 5
# sb.run(same_command + [f"ch64_in_concat_A.{Calculate_and_Visual_SSIM_LD_all}"])  ### 看看Activation 完再concat的效果

##########################################################################################################################################################################################
# ### 6
# sb.run(same_command + [f"unet_2l.{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_3l.{Calculate_and_Visual_SSIM_LD_9te}"])
# sb.run(same_command + [f"unet_4l.{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_5l.{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_6l.{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_7l.{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_8l.{Calculate_and_Visual_SSIM_LD_all}"])

# #############################################################################################################
# ### 7a
# sb.run(same_command + [f"unet_8l_skip_use_add.{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_7l_skip_use_add.{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_6l_skip_use_add.{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_5l_skip_use_add.{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_4l_skip_use_add.{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_3l_skip_use_add.{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_2l_skip_use_add.{Calculate_and_Visual_SSIM_LD_all}"])

#############################################################################################################
### 7b
# sb.run(same_command + [f"unet_IN_7l_2to2noC     .{Calculate_and_Visual_SSIM_LD_9te}"])
# sb.run(same_command + [f"unet_IN_7l_2to2noC_ch32.{Calculate_and_Visual_SSIM_LD_8te}"])
# sb.run(same_command + [f"unet_IN_7l_2to3noC     .{Calculate_and_Visual_SSIM_LD_all}"])  ### 3254
# sb.run(same_command + [f"unet_IN_7l_2to4noC     .{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_IN_7l_2to5noC     .{Calculate_and_Visual_SSIM_LD_all}"])
# sb.run(same_command + [f"unet_IN_7l_2to6noC     .{Calculate_and_Visual_SSIM_LD_all}"])  ### 3073
# sb.run(same_command + [f"unet_IN_7l_2to7noC     .{Calculate_and_Visual_SSIM_LD_all}"])  ### 2851
# sb.run(same_command + [f"unet_IN_7l_2to8noC     .{Calculate_and_Visual_SSIM_LD_9te}"])  ### 2920


# sb.run(same_command + [f"unet_IN_7l_2to3noC_e020.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN  127.28
# sb.run(same_command + [f"unet_IN_7l_2to3noC_e040.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN  127.55
# sb.run(same_command + [f"unet_IN_7l_2to3noC_e060.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN  127.35
# sb.run(same_command + [f"unet_IN_7l_2to3noC_e080.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN  127.28
# sb.run(same_command + [f"unet_IN_7l_2to3noC_e100.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN  127.28

# sb.run(same_command + [f"unet_IN_7l_2to3noC_e120.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN  127.28
# sb.run(same_command + [f"unet_IN_7l_2to3noC_e140.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN  127.28
# sb.run(same_command + [f"unet_IN_7l_2to3noC_e160.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN  127.55
# sb.run(same_command + [f"unet_IN_7l_2to3noC_e180.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN  127.55

#############################################################################################################
### 7c
# sb.run(same_command + [f"unet_IN_7l_skip_use_cnn1_NO_relu   .{Calculate_and_Visual_SSIM_LD_all}"])   ### 127.35
# sb.run(same_command + [f"unet_IN_7l_skip_use_cnn1_USErelu   .{Calculate_and_Visual_SSIM_LD_all}"])   ### 127.28
# sb.run(same_command + [f"unet_IN_7l_skip_use_cnn1_USEsigmoid.{Calculate_and_Visual_SSIM_LD_all}"])   ### 127.35
# sb.run(same_command + [f"unet_IN_7l_skip_use_cnn3_USErelu   .{Calculate_and_Visual_SSIM_LD_all}"])   ### 127.28
# sb.run(same_command + [f"unet_IN_7l_skip_use_cnn3_USEsigmoid.{Calculate_and_Visual_SSIM_LD_all}"])   ### 127.28


#############################################################################################################
### 7d
# sb.run(same_command + [f"ch64_2to3noC_sk_cSE_e060_wrong .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_2to3noC_sk_cSE_e100_wrong .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_2to3noC_sk_cSE_e060       .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_2to3noC_sk_cSE_e100       .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_2to3noC_sk_sSE_e060       .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_2to3noC_sk_sSE_e100       .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_2to3noC_sk_scSE_e060_wrong.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_2to3noC_sk_scSE_e100_wrong.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_2to3noC_sk_scSE_e060      .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_2to3noC_sk_scSE_e100      .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN

# sb.run(same_command + [f"ch64_in_sk_cSE_e060_wrong .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_sk_cSE_e100_wrong .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN

# sb.run(same_command + [f"ch64_in_sk_cSE_e060       .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN  finish
# sb.run(same_command + [f"ch64_in_sk_cSE_e100       .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN  finish
# sb.run(same_command + [f"ch64_in_sk_sSE_e060       .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_sk_sSE_e100       .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN

# sb.run(same_command + [f"ch64_in_sk_scSE_e060_wrong.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_sk_scSE_e100_wrong.{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN

# sb.run(same_command + [f"ch64_in_sk_scSE_e060      .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
# sb.run(same_command + [f"ch64_in_sk_scSE_e100      .{Calculate_and_Visual_SSIM_LD_all}"])  ### 測試真的IN
