...
# sb.run(same_command + [f"mask_have_bg_ch004_sigmoid_bce_ep060.{run}"])  ### 127.35跑
# sb.run(same_command + [f"mask_have_bg_ch002_sigmoid_bce_ep060.{run}"])  ### 127.35跑
# sb.run(same_command + [f"mask_have_bg_ch001_sigmoid_bce_ep060.{run}"])  ### 127.35跑

### 1b. ch and epoch
# sb.run(same_command + [f"mask_have_bg_ch064_sigmoid_bce_ep200.{run}"])  ### 127.37跑
# sb.run(same_command + [f"mask_have_bg_ch128_sigmoid_bce_ep200.{run}"])  ### 127.37跑
# sb.run(same_command + [f"mask_have_bg_ch032_sigmoid_bce_ep200.{run}"])  ### 127.35跑
# sb.run(same_command + [f"mask_have_bg_ch016_sigmoid_bce_ep200.{run}"])  ### 127.35跑
# sb.run(same_command + [f"mask_have_bg_ch008_sigmoid_bce_ep200.{run}"])  ### 127.55跑
# sb.run(same_command + [f"mask_have_bg_ch004_sigmoid_bce_ep200.{run}"])  ### 127.55跑
# sb.run(same_command + [f"mask_have_bg_ch002_sigmoid_bce_ep200.{run}"])  ### 127.55跑
# sb.run(same_command + [f"mask_have_bg_ch001_sigmoid_bce_ep200.{run}"])  ### 127.55跑
...
# sb.run(same_command + [f"mask_have_bg_ch032_4l_sigmoid_bce_ep060.{run}"])  ### 127.37跑
# sb.run(same_command + [f"mask_have_bg_ch032_5l_sigmoid_bce_ep060.{run}"])  ### 127.37跑
# sb.run(same_command + [f"mask_have_bg_ch032_6l_sigmoid_bce_ep060.{run}"])  ### 127.37跑
# sb.run(same_command + [f"mask_have_bg_ch032_7l_sigmoid_bce_ep060.{run}"])  ### 127.37跑
# sb.run(same_command + [f"mask_have_bg_ch032_8l_sigmoid_bce_ep060.{run}"])  ### 127.37跑
## 3. no-concat
# sb.run(same_command + [f"mask_have_bg_ch032_7l_2to2noC_sigmoid_bce_ep060.{run}"])  ### 127.55跑
# sb.run(same_command + [f"mask_have_bg_ch032_7l_2to3noC_sigmoid_bce_ep060.{run}"])  ### 127.55跑
# sb.run(same_command + [f"mask_have_bg_ch032_7l_2to4noC_sigmoid_bce_ep060.{run}"])  ### 127.55跑
# sb.run(same_command + [f"mask_have_bg_ch032_7l_2to5noC_sigmoid_bce_ep060.{run}"])  ### 127.55跑
...
## 4. skip use add
sb.run(same_command + [f"mask_have_bg_ch032_2l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_have_bg_ch032_3l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_have_bg_ch032_4l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_have_bg_ch032_5l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_have_bg_ch032_6l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_have_bg_ch032_7l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_have_bg_ch032_8l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
##########################################################################################################################################################################################
##########################################################################################################################################################################################
##########################################################################################################################################################################################
