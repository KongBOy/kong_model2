...
# sb.run(same_command + ["blender_os_book_flow_unet_epoch500.run()"])     ### 127.35  ### 正在弄 new_shuf  ### 跑錯重跑
# sb.run(same_command + ["blender_os_book_flow_unet_hid_ch_128.run()"])   ### 127.28  ### 正在弄 new_shuf
