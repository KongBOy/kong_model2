...
#####################################################################################################################################################################################################################################################################################################################################
compress_method_name = '"save_as_matplot_bm_rec_visual_after_train"'  ### 兩層是因為加進去 f"" 會被削掉一層～
...
#####################################################################################################################################################################################################################################################################################################################################
calculate_method_name = '"Calculate_SSIM_LD"'  ### 兩層是因為加進去 f"" 會被削掉一層～
calculate_add_loss = True
calculate_bgr2rgb = True
...
calculate_3    = f"build().result_obj.result_do_multiple_single_see(start_see=2, see_amount=1, see_method_name={calculate_method_name}, add_loss={calculate_add_loss}, bgr2rgb={calculate_bgr2rgb}, single_see_core_amount={calculate_single_see_core_amount}, see_print_msg={calculate_result_do_see_print_msg}, see_core_amount={calculate_see_core_amount}, result_print_msg={calculate_result_do_result_print_msg})"
calculate_4    = f"build().result_obj.result_do_multiple_single_see(start_see=3, see_amount=1, see_method_name={calculate_method_name}, add_loss={calculate_add_loss}, bgr2rgb={calculate_bgr2rgb}, single_see_core_amount={calculate_single_see_core_amount}, see_print_msg={calculate_result_do_see_print_msg}, see_core_amount={calculate_see_core_amount}, result_print_msg={calculate_result_do_result_print_msg})"
calculate_8    = f"build().result_obj.result_do_multiple_single_see(start_see=4, see_amount=1, see_method_name={calculate_method_name}, add_loss={calculate_add_loss}, bgr2rgb={calculate_bgr2rgb}, single_see_core_amount={calculate_single_see_core_amount}, see_print_msg={calculate_result_do_see_print_msg}, see_core_amount={calculate_see_core_amount}, result_print_msg={calculate_result_do_result_print_msg})"
calculate_9    = f"build().result_obj.result_do_multiple_single_see(start_see=5, see_amount=1, see_method_name={calculate_method_name}, add_loss={calculate_add_loss}, bgr2rgb={calculate_bgr2rgb}, single_see_core_amount={calculate_single_see_core_amount}, see_print_msg={calculate_result_do_see_print_msg}, see_core_amount={calculate_see_core_amount}, result_print_msg={calculate_result_do_result_print_msg})"
calculate_10   = f"build().result_obj.result_do_multiple_single_see(start_see=6, see_amount=1, see_method_name={calculate_method_name}, add_loss={calculate_add_loss}, bgr2rgb={calculate_bgr2rgb}, single_see_core_amount={calculate_single_see_core_amount}, see_print_msg={calculate_result_do_see_print_msg}, see_core_amount={calculate_see_core_amount}, result_print_msg={calculate_result_do_result_print_msg})"

calculate_2te  = f"build().result_obj.result_do_multiple_single_see(start_see=1, see_amount=6, see_method_name={calculate_method_name}, add_loss={calculate_add_loss}, bgr2rgb={calculate_bgr2rgb}, single_see_core_amount={calculate_single_see_core_amount}, see_print_msg={calculate_result_do_see_print_msg}, see_core_amount={calculate_see_core_amount}, result_print_msg={calculate_result_do_result_print_msg})"
calculate_3te  = f"build().result_obj.result_do_multiple_single_see(start_see=2, see_amount=5, see_method_name={calculate_method_name}, add_loss={calculate_add_loss}, bgr2rgb={calculate_bgr2rgb}, single_see_core_amount={calculate_single_see_core_amount}, see_print_msg={calculate_result_do_see_print_msg}, see_core_amount={calculate_see_core_amount}, result_print_msg={calculate_result_do_result_print_msg})"
calculate_4te  = f"build().result_obj.result_do_multiple_single_see(start_see=3, see_amount=4, see_method_name={calculate_method_name}, add_loss={calculate_add_loss}, bgr2rgb={calculate_bgr2rgb}, single_see_core_amount={calculate_single_see_core_amount}, see_print_msg={calculate_result_do_see_print_msg}, see_core_amount={calculate_see_core_amount}, result_print_msg={calculate_result_do_result_print_msg})"
calculate_8te  = f"build().result_obj.result_do_multiple_single_see(start_see=4, see_amount=3, see_method_name={calculate_method_name}, add_loss={calculate_add_loss}, bgr2rgb={calculate_bgr2rgb}, single_see_core_amount={calculate_single_see_core_amount}, see_print_msg={calculate_result_do_see_print_msg}, see_core_amount={calculate_see_core_amount}, result_print_msg={calculate_result_do_result_print_msg})"
calculate_9te  = f"build().result_obj.result_do_multiple_single_see(start_see=5, see_amount=2, see_method_name={calculate_method_name}, add_loss={calculate_add_loss}, bgr2rgb={calculate_bgr2rgb}, single_see_core_amount={calculate_single_see_core_amount}, see_print_msg={calculate_result_do_see_print_msg}, see_core_amount={calculate_see_core_amount}, result_print_msg={calculate_result_do_result_print_msg})"
calculate_10te = f"build().result_obj.result_do_multiple_single_see(start_see=6, see_amount=1, see_method_name={calculate_method_name}, add_loss={calculate_add_loss}, bgr2rgb={calculate_bgr2rgb}, single_see_core_amount={calculate_single_see_core_amount}, see_print_msg={calculate_result_do_see_print_msg}, see_core_amount={calculate_see_core_amount}, result_print_msg={calculate_result_do_result_print_msg})"
