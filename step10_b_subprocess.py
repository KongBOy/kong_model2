...
compress_all  = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=0, amount=12, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"
compress_1    = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=0, amount=1 , add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"
compress_2    = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=1, amount=1 , add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"
compress_3    = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=2, amount=1 , add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"
compress_4    = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=3, amount=1 , add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"
compress_8    = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=4, amount=1 , add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"
compress_9    = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=5, amount=1 , add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"
compress_10   = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=6, amount=1 , add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"

compress_2te  = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=1, amount=12, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"
compress_3te  = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=2, amount=12, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"
compress_4te  = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=3, amount=12, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"
compress_8te  = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=4, amount=12, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"
compress_9te  = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=5, amount=12, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"
compress_10te = f"build().result_obj.save_all_single_see_as_matplot_bm_rec_visual(start_index=6, amount=12, add_loss=False, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, print_msg={bm_rec_print_msg})"

add_loss = True
single_see_multiprocess = True
calculate_print_msg = False
calculate_all_multiprocess  = f"build().result_obj.calculate_all_single_see_SSIM_LD_multiprocess(add_loss={add_loss}, bgr2rgb=True, core_amount=7, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=2, print_msg={calculate_print_msg})"
calculate_all  = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=0, amount=12, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
calculate_1    = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=0, amount=1 , add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
calculate_2    = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=1, amount=1 , add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
calculate_3    = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=2, amount=1 , add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
calculate_4    = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=3, amount=1 , add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
calculate_8    = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=4, amount=1 , add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
calculate_9    = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=5, amount=1 , add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
calculate_10   = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=6, amount=1 , add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"

calculate_2te  = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=1, amount=12, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
calculate_3te  = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=2, amount=12, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
calculate_4te  = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=3, amount=12, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
calculate_8te  = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=4, amount=12, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
calculate_9te  = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=5, amount=12, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
calculate_10te = f"build().result_obj.calculate_all_single_see_SSIM_LD(start_index=6, amount=12, add_loss={add_loss}, bgr2rgb=True, single_see_multiprocess={single_see_multiprocess}, single_see_core_amount=8, print_msg={calculate_print_msg})"
