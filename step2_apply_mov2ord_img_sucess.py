...
def apply_move(img, move_map, name="0", write_to_step2=False):
    ...
    if(write_to_step2):
        ...
        np.save("step2_result/%s-4-rec_mov_map"%(name),rec_mov.astype(np.float32))
...
if(__name__=="__main__"):
    ...
    move_list = get_db_all_move("step1_result/move_map")


    Check_dir_exist_and_build("step2_result")
