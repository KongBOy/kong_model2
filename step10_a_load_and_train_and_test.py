...
mask_have_bg_ch016_sigmoid_bce_ep060 = Exp_builder().set_basic("train", type9_try_flow_mask_have_bg, mask_unet_ch016_sigmoid, G_bce_loss_info_builder, exp_dir=exp_dir16, describe_mid="6_1", describe_end="mask_have_bg_ch032_sigmoid_bce_ep060") .set_train_args(epochs= 60, exp_bn_see_arg=None).set_train_in_gt_use_range(in_use_range="0~1", gt_use_range="0~1").set_result_name(result_name="")
mask_have_bg_ch008_sigmoid_bce_ep060 = Exp_builder().set_basic("train", type9_try_flow_mask_have_bg, mask_unet_ch008_sigmoid, G_bce_loss_info_builder, exp_dir=exp_dir16, describe_mid="6_1", describe_end="mask_have_bg_ch032_sigmoid_bce_ep060") .set_train_args(epochs= 60, exp_bn_see_arg=None).set_train_in_gt_use_range(in_use_range="0~1", gt_use_range="0~1").set_result_name(result_name="")
