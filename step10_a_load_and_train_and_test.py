...
unet_IN_7l_skip_use_cnn1_USEsigmoid = Exp_builder().set_com("127.35").set_basic("train", type8_blender_os_book_768, flow_unet_IN_7l_ch64_skip_use_cnn1_USEsigmoid,  G_mae_loss_info, exp_dir=exp_dir14, describe_mid="5_14_1_7c_2", describe_end="unet_IN_7l_skip_use_cnn1_USErelu") .set_train_args(epochs=500, epoch_down_step=250, exp_bn_see_arg=None).set_train_in_gt_use_range(in_use_range="0~1", gt_use_range="0~1").build(result_name="")
