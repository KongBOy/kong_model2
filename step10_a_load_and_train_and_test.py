...
# in_01_ch64_in_epoch500_sigmoid_gt_01   = Exp_builder().set_basic("train", type8_blender_os_book_768, flow_unet_IN_ch64_sigmoid, G_mse_loss_info, exp_dir=exp_dir14, describe_mid="5_14_1_8_1", describe_end="01_01_01") .set_train_args(epochs=500, exp_bn_see_arg=None).set_train_in_gt_use_range(in_use_range="0~1", gt_use_range="0~1").build(result_name="")
in_01_ch64_in_epoch500_tanh____gt_tanh = Exp_builder().set_basic("train", type8_blender_os_book_768, flow_unet_IN_ch64        , G_mse_loss_info, exp_dir=exp_dir14, describe_mid="5_14_1_8_1", describe_end="01_th_th") .set_train_args(epochs=200, epoch_down_step=200, exp_bn_see_arg=None).set_train_in_gt_use_range(in_use_range="0~1", gt_use_range="-1~1").build(result_name="")
in_01_ch64_in_epoch500_sigmoid_gt_tanh = Exp_builder().set_basic("train", type8_blender_os_book_768, flow_unet_IN_ch64_sigmoid, G_mse_loss_info, exp_dir=exp_dir14, describe_mid="5_14_1_8_1", describe_end="01_01_th") .set_train_args(epochs=200, epoch_down_step=200, exp_bn_see_arg=None).set_train_in_gt_use_range(in_use_range="0~1", gt_use_range="-1~1").build(result_name="")
in_tanh_ch64_in_epoch500_tanh____gt_01 = Exp_builder().set_basic("train", type8_blender_os_book_768, flow_unet_IN_ch64        , G_mse_loss_info, exp_dir=exp_dir14, describe_mid="5_14_1_8_1", describe_end="th_th_01") .set_train_args(epochs=200, epoch_down_step=200, exp_bn_see_arg=None).set_train_in_gt_use_range(in_use_range="-1~1", gt_use_range="0~1").build(result_name="")
in_tanh_ch64_in_epoch500_sigmoid_gt_01   = Exp_builder().set_basic("train", type8_blender_os_book_768, flow_unet_IN_ch64_sigmoid, G_mse_loss_info, exp_dir=exp_dir14, describe_mid="5_14_1_8_1", describe_end="th_01_01") .set_train_args(epochs=200, epoch_down_step=200, exp_bn_see_arg=None).set_train_in_gt_use_range(in_use_range="-1~1", gt_use_range="0~1").build(result_name="")
in_tanh_ch64_in_epoch500_tanh____gt_tanh = Exp_builder().set_basic("train", type8_blender_os_book_768, flow_unet_IN_ch64        , G_mse_loss_info, exp_dir=exp_dir14, describe_mid="5_14_1_8_1", describe_end="th_th_th") .set_train_args(epochs=200, epoch_down_step=200, exp_bn_see_arg=None).set_train_in_gt_use_range(in_use_range="-1~1", gt_use_range="-1~1").build(result_name="")
in_tanh_ch64_in_epoch500_sigmoid_gt_tanh = Exp_builder().set_basic("train", type8_blender_os_book_768, flow_unet_IN_ch64_sigmoid, G_mse_loss_info, exp_dir=exp_dir14, describe_mid="5_14_1_8_1", describe_end="th_01_th") .set_train_args(epochs=200, epoch_down_step=200, exp_bn_see_arg=None).set_train_in_gt_use_range(in_use_range="-1~1", gt_use_range="-1~1").build(result_name="")
...
if(__name__ == "__main__"):
    if len(sys.argv) < 2:
        ...
        in_tanh_ch64_in_epoch500_tanh____gt_tanh.run()
