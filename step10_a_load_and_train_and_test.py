...
unet_IN_7l_2to2noC      = Exp_builder().set_com("127.28").set_basic("board_rebuild", type8_blender_os_book_768, flow_unet_IN_7l_ch64_2to2noC, G_mae_loss_info, exp_dir=exp_dir14, describe_mid="5_14_1_7b_2", describe_end="unet_IN_7l_2to2noC") .set_train_args(epochs=500, epoch_down_step=250, exp_bn_see_arg=None).set_train_in_gt_use_range(in_use_range="0~1", gt_use_range="0~1").build(result_name="type8_blender_os_book-5_14_1_7b_2-20210416_172119-flow_unet-unet_IN_7l_2to2noC")
