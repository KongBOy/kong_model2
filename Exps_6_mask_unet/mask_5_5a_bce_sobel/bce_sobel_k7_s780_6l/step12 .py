...
if(__name__ == "__main__"):
    ...
    ch_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                                  ...
                                                  row_col_results=[mask_bce_sobel_k7_s780_ch[:4],
                                                                   mask_bce_sobel_k7_s780_ch[4:]], show_in_img=False, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=512, img_w=512)\
    ...
    ep_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                                  ...
                                                  row_col_results=[mask_bce_sobel_k7_s780_ep[:8],
                                                                   mask_bce_sobel_k7_s780_ep[8:]], show_in_img=False, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=512, img_w=512)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=True, single_see_core_amount=6)
    ############################################
    ana_name = "3_noC"
    noC_and_add_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                                  ...
                                                  row_col_results=[mask_bce_sobel_k7_s780_noC_and_add[:3] + [mask_bce_sobel_k7_s780_ch[2]],
                                                                   mask_bce_sobel_k7_s780_noC_and_add[3:] + [mask_bce_sobel_k7_s780_ch[2]]], show_in_img=False, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=512, img_w=512)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=True, single_see_core_amount=6)
    #################################################################################################################################################################################################################