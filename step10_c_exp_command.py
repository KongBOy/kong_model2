...
Calculate_and_Visual_SSIM_LD_all_from_begin  = f"build().result_obj.result_do_all_single_see(start_see=0, see_amount=12, see_method_name='Calculate_and_Visual_SSIM_LD', add_loss=False, bgr2rgb=True, see_core_amount=1, single_see_core_amount=5, see_print_msg={bm_rec_see_print_msg}, result_print_msg={bm_rec_result_print_msg})"
Calculate_and_Visual_SSIM_LD_1_from_begin    = f"build().result_obj.result_do_all_single_see(start_see=0, see_amount=1 , see_method_name='Calculate_and_Visual_SSIM_LD', add_loss=False, bgr2rgb=True, see_core_amount=1, single_see_core_amount=5, see_print_msg={bm_rec_see_print_msg}, result_print_msg={bm_rec_result_print_msg})"
Calculate_and_Visual_SSIM_LD_2_from_begin    = f"build().result_obj.result_do_all_single_see(start_see=1, see_amount=1 , see_method_name='Calculate_and_Visual_SSIM_LD', add_loss=False, bgr2rgb=True, see_core_amount=1, single_see_core_amount=5, see_print_msg={bm_rec_see_print_msg}, result_print_msg={bm_rec_result_print_msg})"
Calculate_and_Visual_SSIM_LD_3_from_begin    = f"build().result_obj.result_do_all_single_see(start_see=2, see_amount=1 , see_method_name='Calculate_and_Visual_SSIM_LD', add_loss=False, bgr2rgb=True, see_core_amount=1, single_see_core_amount=5, see_print_msg={bm_rec_see_print_msg}, result_print_msg={bm_rec_result_print_msg})"
Calculate_and_Visual_SSIM_LD_4_from_begin    = f"build().result_obj.result_do_all_single_see(start_see=3, see_amount=1 , see_method_name='Calculate_and_Visual_SSIM_LD', add_loss=False, bgr2rgb=True, see_core_amount=1, single_see_core_amount=5, see_print_msg={bm_rec_see_print_msg}, result_print_msg={bm_rec_result_print_msg})"
Calculate_and_Visual_SSIM_LD_5_from_begin    = f"build().result_obj.result_do_all_single_see(start_see=4, see_amount=1 , see_method_name='Calculate_and_Visual_SSIM_LD', add_loss=False, bgr2rgb=True, see_core_amount=1, single_see_core_amount=5, see_print_msg={bm_rec_see_print_msg}, result_print_msg={bm_rec_result_print_msg})"
Calculate_and_Visual_SSIM_LD_6_from_begin    = f"build().result_obj.result_do_all_single_see(start_see=5, see_amount=1 , see_method_name='Calculate_and_Visual_SSIM_LD', add_loss=False, bgr2rgb=True, see_core_amount=1, single_see_core_amount=5, see_print_msg={bm_rec_see_print_msg}, result_print_msg={bm_rec_result_print_msg})"
Calculate_and_Visual_SSIM_LD_7_from_begin    = f"build().result_obj.result_do_all_single_see(start_see=6, see_amount=1 , see_method_name='Calculate_and_Visual_SSIM_LD', add_loss=False, bgr2rgb=True, see_core_amount=1, single_see_core_amount=5, see_print_msg={bm_rec_see_print_msg}, result_print_msg={bm_rec_result_print_msg})"
Calculate_and_Visual_SSIM_LD_8_from_begin    = f"build().result_obj.result_do_all_single_see(start_see=8, see_amount=1 , see_method_name='Calculate_and_Visual_SSIM_LD', add_loss=False, bgr2rgb=True, see_core_amount=1, single_see_core_amount=5, see_print_msg={bm_rec_see_print_msg}, result_print_msg={bm_rec_result_print_msg})"
Calculate_and_Visual_SSIM_LD_9_from_begin    = f"build().result_obj.result_do_all_single_see(start_see=9, see_amount=1 , see_method_name='Calculate_and_Visual_SSIM_LD', add_loss=False, bgr2rgb=True, see_core_amount=1, single_see_core_amount=5, see_print_msg={bm_rec_see_print_msg}, result_print_msg={bm_rec_result_print_msg})"
Calculate_and_Visual_SSIM_LD_10_from_begin   = f"build().result_obj.result_do_all_single_see(start_see=10, see_amount=1 , see_method_name='Calculate_and_Visual_SSIM_LD', add_loss=False, bgr2rgb=True, see_core_amount=1, single_see_core_amount=5, see_print_msg={bm_rec_see_print_msg}, result_print_msg={bm_rec_result_print_msg})"
Calculate_and_Visual_SSIM_LD_11_from_begin   = f"build().result_obj.result_do_all_single_see(start_see=11, see_amount=1 , see_method_name='Calculate_and_Visual_SSIM_LD', add_loss=False, bgr2rgb=True, see_core_amount=1, single_see_core_amount=5, see_print_msg={bm_rec_see_print_msg}, result_print_msg={bm_rec_result_print_msg})"
