...
class I_w_M_to_W_to_C(Use_G_generate_Interface):
    ...
    def doing_things(self):
        ...
        if(self.postprocess):
            ...
            cv2.imwrite(private_write_dir + "/" + f"{ep_it_string}_u3_ppt-W_raw_visual.jpg" , W_raw_visual)
            cv2.imwrite(private_write_dir + "/" + f"{ep_it_string}_u3_ppt-W_w_M_visual.jpg" , W_w_M_visual)
