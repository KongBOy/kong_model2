...
# sb.run(same_command + [f"L7_ch016_mae_s001_copy.{compress_and_bm_rec_all}"])
# exit()
#### l2 ############################################################################################
...
# sb.run(same_command + [f"L2_ch001_mae_s001.{compress_and_bm_rec_all}"])
...
# sb.run(same_command + [f"L3_ch001_mae_s001.{compress_and_bm_rec_all}"])
...
####################
# sb.run(same_command + [f"L5_ch001_mae_s001.{compress_and_bm_rec_all}"])  ### 127.55  跑不起來
...
####################
sb.run(same_command + [f"L7_ch016_mae_s001.{compress_and_bm_rec_all}"])
### coord_conv
...
####################
sb.run(same_command + [f"L7_ch004_mae_s001.{compress_and_bm_rec_all}"])
### coord_conv
# sb.run(same_command + [f"L7_ch004_mae_s001_coord_conv.{run}"])
####################
sb.run(same_command + [f"L7_ch002_mae_s001.{compress_and_bm_rec_all}"])
### coord_conv
# sb.run(same_command + [f"L7_ch002_mae_s001_coord_conv.{run}"])
####################
sb.run(same_command + [f"L7_ch001_mae_s001.{compress_and_bm_rec_all}"])
#### 8l ############################################################################################
### coord_conv
# sb.run(same_command + [f"L8_ch016_mae_s001_coord_conv.{run}"])
####################
sb.run(same_command + [f"L8_ch008_mae_s001.{compress_and_bm_rec_all}"])
### coord_conv
...
####################
sb.run(same_command + [f"L8_ch002_mae_s001.{compress_and_bm_rec_all}"])
### coord_conv
# sb.run(same_command + [f"L8_ch002_mae_s001_coord_conv.{run}"])
####################
sb.run(same_command + [f"L8_ch001_mae_s001.{compress_and_bm_rec_all}"])
### coord_conv
