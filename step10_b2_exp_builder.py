...
class Exp_builder():
    ...
    def set_doc3d_subdirs(self, doc3d_subdirs):
        self.exp.doc3d_subdirs = doc3d_subdirs
        return self
    ...
    def Auto_fill_result_name_Read(self):
        ...
        if( "empty" in self.exp.result_name):
        ...
        exp_dir =  kong_model2_dir + "/" + self.exp.exp_dir  ### 舉例：'f:\\kong_model2\\Exps_7_v3\\doc3d\\I_to_M_Gk3_no_pad\\pyr_Tcrop256_pad20_jit15\\pyr_3s\\L3\\step09_3side_L3.py' 只取 'f:\\kong_model2\\Exps_7_v3\\doc3d\\I_to_M_Gk3_no_pad\\pyr_Tcrop256_pad20_jit15\\pyr_3s\\L3'
        auto_fill_result_name_file_paths = get_dir_certain_file_paths(ord_dir=exp_dir, certain_word="Auto_fill_result_name", certain_ext=".txt")
