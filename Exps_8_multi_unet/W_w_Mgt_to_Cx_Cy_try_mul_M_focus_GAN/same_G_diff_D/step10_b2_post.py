...
sb.run(cmd_python_step10_a + [f"L6_ch128.{compress_and_bm_rec_all}"])
...
# sb.run(cmd_python_step10_a + [f"L7_ch064.{compress_and_bm_rec_all}"])
# sb.run(cmd_python_step10_a + [f"L7_ch001.{compress_and_bm_rec_all}"])
# sb.run(cmd_python_step10_a + [f"L7_ch128.{compress_and_bm_rec_all}"])
...
# sb.run(cmd_python_step10_a + [f"L8_ch032.{compress_all}"])
...
# sb.run(cmd_python_step10_a + [f"L9_ch002.{compress_and_bm_rec_all}"])
# sb.run(cmd_python_step10_a + [f"L9_ch004.{compress_and_bm_rec_all}"])
# sb.run(cmd_python_step10_a + [f"L9_ch008.{compress_and_bm_rec_all}"])
# sb.run(cmd_python_step10_a + [f"L9_ch016.{compress_and_bm_rec_all}"])
# sb.run(cmd_python_step10_a + [f"L9_ch032.{run}"])  ### 訓練超出記憶體
# sb.run(cmd_python_step10_a + [f"L9_ch064.{run}"])  ### 訓練超出記憶體
# sb.run(cmd_python_step10_a + [f"L9_ch001.{compress_and_bm_rec_all}"])
