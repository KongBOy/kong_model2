...
# sb.run(cmd_python_step10_a + [f"L1_ch002.{compress_all}"])
...
# sb.run(cmd_python_step10_a + [f"L7_ch128.{run}"])  ### 訓練超出記憶體
...
# sb.run(cmd_python_step10_a + [f"L8_ch032.{compress_and_bm_rec_all}"])
