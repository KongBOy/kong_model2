...
# sb.run(cmd_python_step10_a + [f"L5_ch001.{compress_and_bm_rec_all}"])  ### 試試看
# sb.run(cmd_python_step10_a + [f"L5_ch128.{run}"])
#### 6l ############################################################################################
# sb.run(cmd_python_step10_a + [f"L6_ch032.{compress_all}"])  ### 同色，無法 bm_rec
# sb.run(cmd_python_step10_a + [f"L6_ch016.{compress_all}"])  ### 同色，無法 bm_rec
# sb.run(cmd_python_step10_a + [f"L6_ch008.{compress_all}"])  ### 同色，無法 bm_rec
# sb.run(cmd_python_step10_a + [f"L6_ch004.{compress_all}"])  ### 同色，無法 bm_rec
# sb.run(cmd_python_step10_a + [f"L6_ch002.{compress_all}"])  ### 同色，無法 bm_rec
# sb.run(cmd_python_step10_a + [f"L6_ch001.{compress_all}"])  ### 同色，無法 bm_rec
# sb.run(cmd_python_step10_a + [f"L6_ch064.{compress_all}"])  ### 同色，無法 bm_rec
#### 7l ############################################################################################
