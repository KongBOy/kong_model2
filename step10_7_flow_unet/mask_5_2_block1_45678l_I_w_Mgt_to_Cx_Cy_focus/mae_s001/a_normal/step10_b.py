...
# sb.run(cmd_python_step10_a + [f"L5_ch016.{run}"])  ### flow看起來極差
sb.run(cmd_python_step10_a + [f"L5_ch008.{run}"])
sb.run(cmd_python_step10_a + [f"L5_ch004.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch002.{run}"])  ### flow看起來極差
...
# sb.run(cmd_python_step10_a + [f"L8_ch001.{run}"])  ### 無法 bm_rec
