...
# sb.run(cmd_python_step10_a + [f"L5_ch001.{compress_all}"])  ### 做不起來
#### 6l ############################################################################################
...
# sb.run(cmd_python_step10_a + [f"L6_ch001.{compress_all}"])  ### 做不起來
#### 7l ############################################################################################
...
# sb.run(cmd_python_step10_a + [f"L8_ch001.{compress_all}"])   ### 做不起來
