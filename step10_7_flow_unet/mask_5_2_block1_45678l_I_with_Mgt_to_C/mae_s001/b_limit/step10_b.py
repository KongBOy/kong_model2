...
# sb.run(cmd_python_step10_a + [f"L7_ch016_limit.{compress_and_bm_rec_all}"])
#### 8l ############################################################################################
...
# sb.run(cmd_python_step10_a + [f"L8_ch016_limit.{compress_and_bm_rec_all}"])
# sb.run(cmd_python_step10_a + [f"L8_ch008_limit.{compress_and_bm_rec_all}"])
