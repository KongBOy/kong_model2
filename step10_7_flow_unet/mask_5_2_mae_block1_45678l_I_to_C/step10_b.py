...
# sb.run(cmd_python_step10_a + [f"L2_ch001_mae_s001.{compress_and_bm_rec_all}"])  ### 跑不動
# sb.run(cmd_python_step10_a + [f"L2_ch001_mae_s001_copy.{compress_and_bm_rec_4}"])
#### 3l ############################################################################################
...
# sb.run(cmd_python_step10_a + [f"L7_ch001_mae_s001.{compress_and_bm_rec_all}"])  ### 跑不起來
#### 8l ############################################################################################
