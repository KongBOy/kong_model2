...
class Generator(tf.keras.models.Model):
    def __init__(self, hid_ch=64, depth_level=7, cnn_bias=True, no_concat_layer=0, skip_use_add=False, skip_use_cnn=False, skip_cnn_k=3, skip_use_Acti=None, out_tanh=True, out_ch=3, **kwargs):
        '''
