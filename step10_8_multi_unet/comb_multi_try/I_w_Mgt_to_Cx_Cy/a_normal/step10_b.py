...
sb.run(cmd_python_step10_a + [f"I_to_Cx_L2_ch064_and_I_to_Cy_L2_ch064_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L2_ch032_and_I_to_Cy_L2_ch032_ep060.{run}"])
...
sb.run(cmd_python_step10_a + [f"I_to_Cx_L3_ch064_and_I_to_Cy_L3_ch064_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L3_ch032_and_I_to_Cy_L3_ch032_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L3_ch016_and_I_to_Cy_L3_ch016_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L3_ch008_and_I_to_Cy_L3_ch008_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L3_ch004_and_I_to_Cy_L3_ch004_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L3_ch002_and_I_to_Cy_L3_ch002_ep060.{run}"])
...
sb.run(cmd_python_step10_a + [f"I_to_Cx_L5_ch064_and_I_to_Cy_L5_ch064_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L5_ch016_and_I_to_Cy_L5_ch016_ep060.{run}"])
...
sb.run(cmd_python_step10_a + [f"I_to_Cx_L6_ch016_and_I_to_Cy_L6_ch016_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L6_ch008_and_I_to_Cy_L6_ch008_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L6_ch004_and_I_to_Cy_L6_ch004_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L6_ch002_and_I_to_Cy_L6_ch002_ep060.{run}"])
...
sb.run(cmd_python_step10_a + [f"I_to_Cx_L8_ch016_and_I_to_Cy_L8_ch016_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L8_ch008_and_I_to_Cy_L8_ch008_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L8_ch004_and_I_to_Cy_L8_ch004_ep060.{run}"])
sb.run(cmd_python_step10_a + [f"I_to_Cx_L8_ch002_and_I_to_Cy_L8_ch002_ep060.{run}"])
