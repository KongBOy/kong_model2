...
# sb.run(cmd_python_step10_a + [f"I_to_M_L4_ch128_and_M_w_I_to_C_L5_ch128_ep060.{compython press_and_bm_rec_all}"])
...
# sb.run(cmd_python_step10_a + [f"I_to_M_L4_ch128_and_M_w_I_to_C_L5_ch001_ep060.{compress_and_bm_rec_all}"])
