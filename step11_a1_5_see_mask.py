...
class See_mask(See_info):
    ...
    def get_mask_info(self):
        ...
        get_info：放 ..._names
                     ...
                     file_amount
        """
        self.mask_names                                = get_dir_certain_file_names(self.mask_read_dir , certain_word="epoch", certain_ext=".bmp", print_msg=False)
        if(len(self.mask_names) == 0): self.mask_names = get_dir_certain_file_names(self.mask_read_dir , certain_word="epoch", certain_ext=".jpg", print_msg=False)
