...
if(__name__ == "__main__"):
    ...
    # try_npy_to_npz = See( result_read_dir=Result_Read_Dir + "result/5_14_flow_unet/type8_blender_os_book-5_14_3b_4-20210306_231628-flow_unet-ch32_bn_16", see_name="see_001-real")
    # try_npy_to_npz = See( result_read_dir=Result_Read_Dir + "result/5_14_flow_unet/type8_blender_os_book-5_14_1_6-20210308_100044-flow_unet-new_shuf_epoch700", see_name="see_001-real")
    # try_npy_to_npz = See( result_read_dir=Result_Read_Dir + "result/5_14_flow_unet/type8_blender_os_book-5_14_1_6-20210308_100044-flow_unet-new_shuf_epoch700", see_name="see_005-train")
    # try_npy_to_npz.npy_to_npz_comapre()
    # try_npy_to_npz.Npy_to_npz(multiprocess=True)
    # try_npy_to_npz.Npy_to_npz(multiprocess=True)

    test_see = See(result_read_dir=Result_Read_Dir + "result/5_14_flow_unet/type8_blender_os_book-testest", result_write_dir=Result_Write_Dir + "result/5_14_flow_unet/type8_blender_os_book-testest", see_name="see_001-real")
