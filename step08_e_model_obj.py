...
mask_unet2_block1_ch032_tanh_6l = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet2(hid_ch= 32, depth_level=6, true_IN=True, out_ch=1, conv_block_num=1).use_mask_unet2().set_train_step(train_step_pure_G_split_mask_move)
mask_unet2_block1_ch128_sig_6l  = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet2(hid_ch=128, depth_level=6, true_IN=True, out_tanh=False, out_ch=1, conv_block_num=1).use_mask_unet2().set_train_step(train_step_pure_G_split_mask_move)
mask_unet2_block1_ch064_sig_6l  = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet2(hid_ch= 64, depth_level=6, true_IN=True, out_tanh=False, out_ch=1, conv_block_num=1).use_mask_unet2().set_train_step(train_step_pure_G_split_mask_move)
mask_unet2_block1_ch032_sig_6l  = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet2(hid_ch= 32, depth_level=6, true_IN=True, out_tanh=False, out_ch=1, conv_block_num=1).use_mask_unet2().set_train_step(train_step_pure_G_split_mask_move)
mask_unet2_block1_ch016_sig_6l  = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet2(hid_ch= 16, depth_level=6, true_IN=True, out_tanh=False, out_ch=1, conv_block_num=1).use_mask_unet2().set_train_step(train_step_pure_G_split_mask_move)
mask_unet2_block1_ch008_sig_6l  = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet2(hid_ch=  8, depth_level=6, true_IN=True, out_tanh=False, out_ch=1, conv_block_num=1).use_mask_unet2().set_train_step(train_step_pure_G_split_mask_move)
mask_unet2_block1_ch004_sig_6l  = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet2(hid_ch=  4, depth_level=6, true_IN=True, out_tanh=False, out_ch=1, conv_block_num=1).use_mask_unet2().set_train_step(train_step_pure_G_split_mask_move)
mask_unet2_block1_ch002_sig_6l  = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet2(hid_ch=  2, depth_level=6, true_IN=True, out_tanh=False, out_ch=1, conv_block_num=1).use_mask_unet2().set_train_step(train_step_pure_G_split_mask_move)
mask_unet2_block1_ch001_sig_6l  = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet2(hid_ch=  1, depth_level=6, true_IN=True, out_tanh=False, out_ch=1, conv_block_num=1).use_mask_unet2().set_train_step(train_step_pure_G_split_mask_move)
