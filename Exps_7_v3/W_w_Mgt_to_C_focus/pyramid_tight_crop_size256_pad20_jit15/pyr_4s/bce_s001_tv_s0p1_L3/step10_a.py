...
use_loss_obj = [G_mae_s001_loss_info_builder.set_loss_target("UNet_C").copy()]  ### z, y, x 順序是看 step07_b_0b_Multi_UNet 來對應的喔
#############################################################
