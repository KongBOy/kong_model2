...
if(__name__ == "__main__"):
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_8_2side_1_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_2
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_8_2side_2_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_3
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_8_2side_3_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_8_2side_4_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_5
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_8_2side_5_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_6
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_8_2side_6_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_7
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_8_2side_7_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_8
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_8_2side_8_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ########
    # 1side_9
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_9_2side_1_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_2
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_9_2side_2_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_3
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_9_2side_3_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_9_2side_4_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_5
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_9_2side_5_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_6
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_9_2side_6_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_7
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_9_2side_7_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_8
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_9_2side_8_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
    ### 2side_9
    ...
    analyzer = Row_col_results_analyzer(ana_describe=f"{ana_dir}/0_ana_{ana_name}",
                                        ana_what_sees="see",
                                        ana_what="rec",
                                        row_col_results=ch032_1side_9_2side_9_34side_all, show_in_img=True, show_gt_img=False, bgr2rgb=True, add_loss=False, img_h=256, img_w=256, fontsize= 8, title_fontsize=16, jump_to=40)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=False, single_see_core_amount=6)\
                                            # .Gather_all_see_final_img()
