...
### p20
# sb.run(cmd_python_step10_a + [f"p20_L5_Mae__Mae            .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Mae__Sob_k05        .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Mae__Sob_k15        .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Mae__Sob_k25        .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Mae__Sob_k35        .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Mae__Sob_k05_Mae    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Mae__Sob_k15_Mae    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Mae__Sob_k25_Mae    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Mae__Sob_k35_Mae    .{run}"])

# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05__Mae        .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05__Sob_k05    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05__Sob_k15    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05__Sob_k25    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05__Sob_k35    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05__Sob_k05_Mae.{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05__Sob_k15_Mae.{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05__Sob_k25_Mae.{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05__Sob_k35_Mae.{run}"])

# sb.run(cmd_python_step10_a + [f"p20_L5_Mae__Mae            .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05__Mae        .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k15__Mae        .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k25__Mae        .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k35__Mae        .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05_Mae__Mae    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k15_Mae__Mae    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k25_Mae__Mae    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k35_Mae__Mae    .{run}"])

# sb.run(cmd_python_step10_a + [f"p20_L5_Mae__Sob_k05        .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05__Sob_k05    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k15__Sob_k05    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k25__Sob_k05    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k35__Sob_k05    .{run}"])
# sb.run(cmd_python_step10_a + [f"p20_L5_Sob_k05_Mae__Sob_k05.{run}"])
