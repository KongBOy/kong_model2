...
# sb.run(cmd_python_step10_a + [f"p20_L5_wiDiv_Sob_k09_Mae_ep010__Sob_k09_Mae       .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])
