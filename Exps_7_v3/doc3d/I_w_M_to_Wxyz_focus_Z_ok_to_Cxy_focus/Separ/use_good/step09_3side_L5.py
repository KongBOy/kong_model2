...
from Exps_7_v3.doc3d.I_w_M_to_W_Comb.step09_2side_L5 import ch032_pyramid_1side_6__2side_6_woDiv as I_w_M_to_W_p20_2s_L5_woDiv_ch032
...
from Exps_7_v3.doc3d.I_w_M_to_W_focus_Zok_div.ch016.wiColorJ.Add2Loss.Sob_k09_s001_Mae_s001_good.pyr_Tcrop255_p20_j15.pyr_2s.L5.step09_2side_L5 import ch032_pyramid_1side_6__2side_5 as I_w_M_to_W_p20_2s_L5_ch016_1s6__2s5_wiDiv
...
###############################################################################################################################################################################################
###############################################################################################################################################################################################
ch032_pyramid_1side_6__2side_6_p20_L5_woDiv_ch032 = KModel_builder().set_model_name(MODEL_NAME.multi_flow_unet).set_multi_model_builders(op_type="I_to_Wxyz_to_Cxy_general", I_to_Wx_Wy_Wz=I_w_M_to_W_p20_2s_L5_woDiv_ch032, W_to_Cx_Cy=W_w_M_to_Cxy_Tcrop255_p20_2s_L5).set_multi_model_separate_focus(I_to_W_separ=False, I_to_W_focus=True, W_to_C_separ=True, W_to_C_focus=True).set_gen_op( use_gen_op_p20 ).set_train_step( use_train_step_p20 )
...
ch032_pyramid_1s6_2s5__1s6_2s6__p20_L5_wiDiv = KModel_builder().set_model_name(MODEL_NAME.multi_flow_unet).set_multi_model_builders(op_type="I_to_Wxyz_to_Cxy_general", I_to_Wx_Wy_Wz=I_w_M_to_W_p20_2s_L5_ch016_1s6__2s5_wiDiv, W_to_Cx_Cy=W_w_M_to_Cxy_Tcrop255_p20_2s_L5).set_multi_model_separate_focus(I_to_W_separ=True , I_to_W_focus=True, W_to_C_separ=True, W_to_C_focus=True).set_gen_op( use_gen_op_p20 ).set_train_step( use_train_step_p20 )
#########################################################################################
###############################################################################################################################################################################################
