...
#################################
### good
# sb.run(cmd_python_step10_a + [f"good_p20_wiColorJ_L5_MaeSob_k09__MaeSob_k09                      .{test_Calculate_SSIM_LD_all_from_begin % 'test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA'}"])
# sb.run(cmd_python_step10_a + [f"good_p20_wiColorJ_L5_MaeSob_k09__MaeSob_k03                      .{test_Calculate_SSIM_LD_all_from_begin % 'test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA'}"])
