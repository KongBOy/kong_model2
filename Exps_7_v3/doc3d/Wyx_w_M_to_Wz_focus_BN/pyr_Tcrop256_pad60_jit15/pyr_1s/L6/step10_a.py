...
use_loss_obj = [G_mae_s001_loss_info_builder.set_loss_target("UNet_Wz").copy()]
batch_size = 10
#############################################################
...
ch032_1side_7_ep10 = Exp_builder().set_basic("train", use_db_obj, ch032_pyramid_1side_7, use_loss_obj, exp_dir=exp_dir, code_exe_path=code_exe_path, describe_end=ch032_pyramid_1side_7.kong_model.model_describe) .set_train_args(epochs= 10, batch_size=batch_size) .set_train_iter_args(it_see_fq=900 // batch_size, it_save_fq=(900 * 2) // batch_size, it_down_step="half", it_down_fq=900 // batch_size).set_train_in_gt_use_range(use_in_range=Range(0, 1), use_gt_range=Range(0, 1)).set_result_name(result_name="L6_ch032_bl_pyr__1s7-20220512_192419_ep10")  ### 127.55
ch032_1side_7_ep10 = Exp_builder().set_basic("train", use_db_obj, ch032_pyramid_1side_7, use_loss_obj, exp_dir=exp_dir, code_exe_path=code_exe_path, describe_end=ch032_pyramid_1side_7.kong_model.model_describe) .set_train_args(epochs= 10, batch_size=batch_size) .set_train_iter_args(it_see_fq=900 // batch_size, it_save_fq=(900 * 2) // batch_size, it_down_step="half", it_down_fq=900 // batch_size).set_train_in_gt_use_range(use_in_range=Range(0, 1), use_gt_range=Range(0, 1)).set_result_name(result_name="L6_ch032_bl_pyr__1s7-20220512_225759_ep10")  ### 127.29，待確認一下反正重複了
#############################################################
