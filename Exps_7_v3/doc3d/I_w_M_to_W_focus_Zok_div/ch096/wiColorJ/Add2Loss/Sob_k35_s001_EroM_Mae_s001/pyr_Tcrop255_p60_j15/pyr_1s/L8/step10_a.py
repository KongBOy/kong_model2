...
use_loss_obj = [mae_s001_sobel_k35_s001_EroseM_loss_info_builder.set_loss_target("UNet_Wz").copy(), mae_s001_sobel_k35_s001_EroseM_loss_info_builder.set_loss_target("UNet_Wy").copy(), mae_s001_sobel_k35_s001_EroseM_loss_info_builder.set_loss_target("UNet_Wx").copy()]  ### z, y, x 順序是看 step07_b_0b_Multi_UNet 來對應的喔
#############################################################
