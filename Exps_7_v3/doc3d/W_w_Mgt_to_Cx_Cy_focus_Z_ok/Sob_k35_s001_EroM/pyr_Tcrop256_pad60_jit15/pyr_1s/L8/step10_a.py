...
use_loss_obj = [G_sobel_k35_erose_M_loss_info_builder.set_loss_target("UNet_Cx").copy(), G_sobel_k35_erose_M_loss_info_builder.set_loss_target("UNet_Cy").copy()]  ### z, y, x 順序是看 step07_b_0b_Multi_UNet 來對應的喔
#############################################################
