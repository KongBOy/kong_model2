...
# sb.run(cmd_python_step10_a + [f"ch032_1side_5.{compress_all}"])
# sb.run(cmd_python_step10_a + [f"ch032_1side_6.{compress_all}"])
# sb.run(cmd_python_step10_a + [f"ch032_1side_7.{compress_all}"])
# sb.run(cmd_python_step10_a + [f"ch032_1side_8.{compress_all}"])
