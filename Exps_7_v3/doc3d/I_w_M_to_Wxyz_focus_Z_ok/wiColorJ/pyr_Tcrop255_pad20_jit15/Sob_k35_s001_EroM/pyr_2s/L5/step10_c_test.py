...
# sb.run(cmd_python_step10_a + [f"ch032_1side_6__2side_6.{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel2', 'knpy_save=False')}"])
sb.run(cmd_python_step10_a + [f"ch032_1side_6__2side_6.{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel4', 'knpy_save=False')}"])
