...
###############################################################################################################################################################################################
### 幾乎完全模仿 DewarpNet
DewarpUNet_I_w_M_to_W_BN = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet3(out_conv_block=False, concat_before_down=False, use_bias=False, norm="bn", kernel_size=4, padding="same", hid_ch=use_hid_ch, depth_level=7, out_ch=3, unet_acti="sigmoid", conv_block_num=blk_0s_L7, ch_upper_bound= 2 ** 9) .set_gen_op( I_w_M_to_W_woDiv_in_have_bg_use_gen_op ).set_train_step( I_w_M_to_W_woDiv_in_have_bg_use_train_step )
DewarpUNet_W_w_M_to_C_BN = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet3(out_conv_block=False, concat_before_down=False, use_bias=False, norm="bn", kernel_size=4, padding="same", hid_ch=use_hid_ch, depth_level=7, out_ch=2, unet_acti="sigmoid", conv_block_num=blk_0s_L7, ch_upper_bound= 2 ** 9) .set_gen_op( W_w_M_to_C_woDiv_in_have_bg_use_gen_op ).set_train_step( W_w_M_to_C_woDiv_in_have_bg_use_train_step )
DewarpUNet_Gather_BN     = KModel_builder().set_model_name(MODEL_NAME.multi_flow_unet).set_multi_model_builders(op_type="I_to_Wxyz_to_Cxy_general", I_to_Wx_Wy_Wz=DewarpUNet_I_w_M_to_W_BN, W_to_Cx_Cy=DewarpUNet_W_w_M_to_C_BN).set_multi_model_separate_focus(I_to_W_separ=False , I_to_W_focus=False, W_to_C_separ=False , W_to_C_focus=False).set_gen_op( gather_in_have_bg_use_gen_op_p20 ).set_train_step( gather_in_have_bg_use_train_step_p20 )
###############################################################################################################################################################################################
...
if(__name__ == "__main__"):
    ...
    use_model = DewarpUNet_I_w_M_to_W_BN
