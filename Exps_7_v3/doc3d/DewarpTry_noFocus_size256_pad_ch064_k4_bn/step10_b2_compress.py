...
### 目前最接近 DewarpNet的架構
# sb.run(cmd_python_step10_a + [f"exp_DewarpUNet_I_w_M_to_W_BN__in_have_bg .{compress_all}"])
# sb.run(cmd_python_step10_a + [f"exp_DewarpUNet_W_w_M_to_C_BN__in_have_bg .{compress_all}"])
# sb.run(cmd_python_step10_a + [f"exp_DewarpUNet_Gather_BN__in_have_bg     .{compress_all}"])
