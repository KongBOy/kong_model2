...
# sb.run(cmd_python_step10_a + [f"I_w_M_to_W__ch016_L5_2blk__woDiv_less__Mae_s001_Sob_k09_s001                    .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])
...
# sb.run(cmd_python_step10_a + [f"W_w_M_to_C__ch016_L5_2blk__woDiv_less__Mae_s001_Sob_k09_s001                    .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])
