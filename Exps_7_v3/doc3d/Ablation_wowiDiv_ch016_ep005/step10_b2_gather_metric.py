...
# sb.run(cmd_python_step10_a + [f"I_w_M_to_W__ch016_L5_2blk__wiDiv__Mae_s001_Sob_k09_s001                         .{Gather_test_SSIM_LD % 'test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA'}"])
# sb.run(cmd_python_step10_a + [f"I_w_M_to_W__ch016_L5_2blk__woDiv__Mae_s001_Sob_k09_s001                         .{Gather_test_SSIM_LD % 'test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA'}"])
# sb.run(cmd_python_step10_a + [f"I_w_M_to_W__ch016_L5_2blk__woDiv_less__Mae_s001_Sob_k09_s001                    .{Gather_test_SSIM_LD % 'test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA'}"])
...
# sb.run(cmd_python_step10_a + [f"W_w_M_to_C__ch016_L5_2blk__woDiv_less__Mae_s001_Sob_k09_s001                    .{Gather_test_SSIM_LD % 'test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA'}"])
...
# sb.run(cmd_python_step10_a + [f"I_w_M_to_W__woDiv_less_Sob_k09_Mae_ep001__W_w_M_to_C_woDiv_less_Sob_k09_Mae_ep001__ep002 .{Gather_test_SSIM_LD % 'test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA'}"])
