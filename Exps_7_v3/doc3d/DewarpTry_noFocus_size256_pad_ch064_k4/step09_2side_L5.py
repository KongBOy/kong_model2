...
DewarpUNet_W_w_M_to_C_IN = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet3(out_conv_block=False, concat_before_down=False, use_bias=False, norm="in", kernel_size=4, padding="same", hid_ch=use_hid_ch, depth_level=7, out_ch=2, unet_acti="sigmoid", conv_block_num=blk_0s_L7, ch_upper_bound= 2 ** 9) .set_gen_op( I_w_M_to_W_woDiv_in_have_bg_use_gen_op ).set_train_step( I_w_M_to_W_woDiv_in_have_bg_use_train_step )
