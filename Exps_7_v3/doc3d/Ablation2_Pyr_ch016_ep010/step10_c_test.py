...
# sb.run(cmd_python_step10_a + [f"W_w_M_to_C__ch016_L5__3UNet__Full_Less                        .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])
# sb.run(cmd_python_step10_a + [f"W_w_M_to_C__ch016_L5__3UNet__Full_More                        .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])
# sb.run(cmd_python_step10_a + [f"W_w_M_to_C__ch016_L5__3UNet__NoFu_Less                        .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])
# sb.run(cmd_python_step10_a + [f"W_w_M_to_C__ch016_L5__3UNet__NoFu_More                        .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])

# sb.run(cmd_python_step10_a + [f"W_w_M_to_C__ch016_L5__wiDiv__Full_Less                        .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])
# sb.run(cmd_python_step10_a + [f"W_w_M_to_C__ch016_L5__wiDiv__Full_More                        .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])
# sb.run(cmd_python_step10_a + [f"W_w_M_to_C__ch016_L5__wiDiv__NoFu_Less                        .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])
# sb.run(cmd_python_step10_a + [f"W_w_M_to_C__ch016_L5__wiDiv__NoFu_More                        .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])
...
# sb.run(cmd_python_step10_a + [f"W_w_M_to_C__ch016_L5__woD_L__Full_More                        .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])
