...
# sb.run(cmd_python_step10_a + [f"exp_L5_gather_noFocus_ChBg__I_w_M_to_W_noFocus_W_w_M_to_C_noFocus_ChBg .{test % ('test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA', 'knpy_save=False')}"])
