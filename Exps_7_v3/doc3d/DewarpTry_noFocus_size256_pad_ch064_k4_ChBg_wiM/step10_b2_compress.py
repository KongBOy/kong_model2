...
### 目前最接近 DewarpNet的架構
# sb.run(cmd_python_step10_a + [f"exp_DewarpUNet_ep010_I_w_M_to_W_IN__in_have_bg .{compress_all}"])
# sb.run(cmd_python_step10_a + [f"exp_DewarpUNet_ep010_W_w_M_to_C_IN__in_have_bg .{compress_all}"])
# sb.run(cmd_python_step10_a + [f"exp_DewarpUNet_ep010_Gather_IN__in_have_bg     .{compress_all}"])
# sb.run(cmd_python_step10_a + [f"exp_DewarpUNet_ep015_I_w_M_to_W_IN__in_have_bg .{compress_all}"])
# sb.run(cmd_python_step10_a + [f"exp_DewarpUNet_ep015_W_w_M_to_C_IN__in_have_bg .{compress_all}"])
# sb.run(cmd_python_step10_a + [f"exp_DewarpUNet_ep015_Gather_IN__in_have_bg     .{compress_all}"])
