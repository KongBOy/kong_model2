...
use_loss_obj = [mae_s001_sobel_k05_s001_EroseM_loss_info_builder.set_loss_target("UNet_Wz").copy()]
#############################################################
