...
#############################################################
# sb.run(cmd_python_step10_a + [f"gather_ep010__ch032_1s6_2s5_3s2__ch032_1s3_2s2_3s2   .{run}"])
# sb.run(cmd_python_step10_a + [f"gather_ep010__ch032_1s6_2s5_3s2__ch032_1s3_2s2_3s2__2.{run}"])
# sb.run(cmd_python_step10_a + [f"gather_ep010__ch032_1s6_2s5_3s2__ch032_1s3_2s2_3s2__3.{run}"])
# sb.run(cmd_python_step10_a + [f"gather_ep010__ch032_1s6_2s5_3s2__ch032_1s3_2s2_3s2__4.{run}"])
# sb.run(cmd_python_step10_a + [f"gather_ep010__ch032_1s6_2s5_3s2__ch032_1s3_2s2_3s2__5.{run}"])
# sb.run(cmd_python_step10_a + [f"gather_ep010__ch032_1s6_2s5_3s2__ch032_1s6_2s6_3s1   .{run}"])
