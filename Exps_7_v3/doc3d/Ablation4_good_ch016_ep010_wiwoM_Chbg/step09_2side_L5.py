...
###############################################################################################################################################################################################
use_what_blocks =  [3, 3, 2, 2, 2, 1, 2, 2, 2, 3, 3]
#########################################################################################
### I_w_M_to_C woDiv
I_w_M_to_W_ch016_L5_normal       = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet3(out_conv_block=True, concat_before_down=True, kernel_size=3, padding="valid", hid_ch=use_hid_ch , d_acti="relu", depth_level=5, out_ch=3, unet_acti="sigmoid", conv_block_num=use_what_blocks, ch_upper_bound= 2 ** 14) .set_gen_op( I_w_M_to_W_normal_use_gen_op       ).set_train_step( I_w_M_to_W_normal_use_train_step )
I_w_M_to_W_ch016_L5_ChBg         = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet3(out_conv_block=True, concat_before_down=True, kernel_size=3, padding="valid", hid_ch=use_hid_ch , d_acti="relu", depth_level=5, out_ch=3, unet_acti="sigmoid", conv_block_num=use_what_blocks, ch_upper_bound= 2 ** 14) .set_gen_op( I_w_M_to_W_ChBg_use_gen_op         ).set_train_step( I_w_M_to_W_ChBg_use_train_step )
I_w_M_to_W_ch016_L5_noFocus      = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet3(out_conv_block=True, concat_before_down=True, kernel_size=3, padding="valid", hid_ch=use_hid_ch , d_acti="relu", depth_level=5, out_ch=3, unet_acti="sigmoid", conv_block_num=use_what_blocks, ch_upper_bound= 2 ** 14) .set_gen_op( I_w_M_to_W_noFocus_use_gen_op      ).set_train_step( I_w_M_to_W_noFocus_use_train_step )
I_w_M_to_W_ch016_L5_noFocus_ChBg = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet3(out_conv_block=True, concat_before_down=True, kernel_size=3, padding="valid", hid_ch=use_hid_ch , d_acti="relu", depth_level=5, out_ch=3, unet_acti="sigmoid", conv_block_num=use_what_blocks, ch_upper_bound= 2 ** 14) .set_gen_op( I_w_M_to_W_noFocus_ChBg_use_gen_op ).set_train_step( I_w_M_to_W_noFocus_ChBg_use_train_step )
### W_w_M_to_C woDiv， 沒有 ChBg 和 ColorJit
W_w_M_to_C_ch016_L5_normal       = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet3(out_conv_block=True, concat_before_down=True, kernel_size=3, padding="valid", hid_ch=use_hid_ch , d_acti="relu", depth_level=5, out_ch=2, unet_acti="sigmoid", conv_block_num=use_what_blocks, ch_upper_bound= 2 ** 14) .set_gen_op( W_w_M_to_C_normal_use_gen_op       ).set_train_step( W_w_M_to_C_normal_use_train_step )
W_w_M_to_C_ch016_L5_noFocus_ChBg = KModel_builder().set_model_name(MODEL_NAME.flow_unet2).set_unet3(out_conv_block=True, concat_before_down=True, kernel_size=3, padding="valid", hid_ch=use_hid_ch , d_acti="relu", depth_level=5, out_ch=2, unet_acti="sigmoid", conv_block_num=use_what_blocks, ch_upper_bound= 2 ** 14) .set_gen_op( W_w_M_to_C_noFocus_ChBg_use_gen_op ).set_train_step( W_w_M_to_C_noFocus_ChBg_use_train_step )
#########################################################################################
###############################################################################################################################################################################################
### 合起來也寫一起好了拉
