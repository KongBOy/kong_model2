...
### W_w_M_to_C woDiv
# sb.run(cmd_python_step10_a + [f"exp_W_w_M_to_C_ch016_L5_normal       .{test_Calculate_SSIM_LD_all_from_begin % 'test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA'}"])
...
# sb.run(cmd_python_step10_a + [f"exp_L5_gather_noFocus_ChBg__I_w_M_to_W_noFocus_W_w_M_to_C_noFocus_ChBg__1 .{test_Calculate_SSIM_LD_all_from_begin % 'test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA'}"])
...
# sb.run(cmd_python_step10_a + [f"exp_L5_gather_noFocus_ChBg__I_w_M_to_W_noFocus_W_w_M_to_C_noFocus_ChBg__3 .{test_Calculate_SSIM_LD_all_from_begin % 'test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA'}"])
# sb.run(cmd_python_step10_a + [f"exp_L5_gather_noFocus_ChBg__I_w_M_to_W_noFocus_W_w_M_to_C_noFocus_ChBg__4 .{test_Calculate_SSIM_LD_all_from_begin % 'test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA'}"])
# sb.run(cmd_python_step10_a + [f"exp_L5_gather_noFocus_ChBg__I_w_M_to_W_noFocus_W_w_M_to_C_noFocus_ChBg__5 .{test_Calculate_SSIM_LD_all_from_begin % 'test_Kong_Crop_p60_gt_DewarpNet_p60_then_Use_KModel5_FBA'}"])
