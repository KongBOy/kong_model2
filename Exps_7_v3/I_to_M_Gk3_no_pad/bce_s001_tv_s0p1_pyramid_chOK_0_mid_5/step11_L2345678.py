...
Layer2345678_Ch = [
    ...
    [block1.L6_ch128_limit.build().result_obj,
    ...
    [block1.L7_ch128_limit.build().result_obj,
     block1.L7_ch064_limit.build().result_obj,
    ...
    [block1.L8_ch128_limit.build().result_obj,
     block1.L8_ch064_limit.build().result_obj,
     block1.L8_ch032_limit.build().result_obj,
...
block1_mask_L45678_normal_vs_limit = [
    [block1.L4_ch128.build().result_obj, block1.L4_ch128_limit.build().result_obj, block1.L6_ch032.build().result_obj, block1.L6_ch032_limit.build().result_obj, block1.L7_ch032.build().result_obj, block1.L7_ch032_limit.build().result_obj, ],
    [block1.L5_ch064.build().result_obj, block1.L5_ch064_limit.build().result_obj, block1.L6_ch064.build().result_obj, block1.L6_ch064_limit.build().result_obj, block1.L8_ch008.build().result_obj, block1.L8_ch008_limit.build().result_obj, ],
    [block1.L5_ch128.build().result_obj, block1.L5_ch128_limit.build().result_obj, block1.L7_ch016.build().result_obj, block1.L7_ch016_limit.build().result_obj, block1.L8_ch016.build().result_obj, block1.L8_ch016_limit.build().result_obj, ],
]
