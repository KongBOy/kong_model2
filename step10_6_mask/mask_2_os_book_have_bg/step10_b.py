...
### 3. no-concat
sb.run(same_command + [f"mask_h_bg_ch032_7l_2to2noC_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_h_bg_ch032_7l_2to3noC_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_h_bg_ch032_7l_2to4noC_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_h_bg_ch032_7l_2to5noC_sig_bce_ep060.{run}"])  ### 127.35跑
