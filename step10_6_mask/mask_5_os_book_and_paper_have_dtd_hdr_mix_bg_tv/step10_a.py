...
if(__name__ == "__main__"):
    ...
    if len(sys.argv) < 2:
        ...
        mask_h_bg_ch128_sig_tv_ep060.build().run()
        # print('no argument')
        sys.exit()
