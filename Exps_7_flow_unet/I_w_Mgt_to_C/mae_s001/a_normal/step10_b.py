...
# sb.run(cmd_python_step10_a + [f"L3_ch001.{run}"])  ### flow 看起來極差
# #### 4l ############################################################################################
...
# sb.run(cmd_python_step10_a + [f"L4_ch001.{run}"])  ### flow 看起來極差
# #### 5l ############################################################################################
...
# # sb.run(cmd_python_step10_a + [f"L5_ch001.{run}"])  ### 做不起來
# #### 6l ############################################################################################
...
# sb.run(cmd_python_step10_a + [f"L6_ch001.{run}"])  ### 做不起來
#### 7l ############################################################################################
...
# sb.run(cmd_python_step10_a + [f"L8_ch001.{run}"])   ### 做不起來
