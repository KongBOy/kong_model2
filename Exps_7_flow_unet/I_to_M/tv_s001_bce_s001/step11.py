...
import tv_s001_bce_s001.a_normal.step10_a as block1
import tv_s001_bce_s001.b_limit .step10_a as block1_limit
#################################################################################################################################################################################################################################################################################################################################################################################################
### L2345678_flow
...
block1_mask_L45678_normal_vs_limit = [
    [block1.L4_ch128.build().result_obj, block1_limit.L4_ch128_limit.build().result_obj, block1.L6_ch032.build().result_obj, block1_limit.L6_ch032_limit.build().result_obj, ],
    [block1.L5_ch064.build().result_obj, block1_limit.L5_ch064_limit.build().result_obj, block1.L6_ch064.build().result_obj, block1_limit.L6_ch064_limit.build().result_obj, ],
    [block1.L5_ch128.build().result_obj, block1_limit.L5_ch128_limit.build().result_obj, ],
]
