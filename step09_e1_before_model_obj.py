...
#######################################################################################################################
justG               = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG(first_k3=False).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_firstk3       = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG(first_k3=True ).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
########################################################### 2
justG_mrf7          = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=False, mrf_replace=False, use7=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_mrf7_k3       = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=True , mrf_replace=False, use7=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_mrf5_k3       = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=True , mrf_replace=False, use5=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_mrf3_k3       = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=True , mrf_replace=False, use3=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
########################################################### 3
justG_mrf79         = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=False, mrf_replace=False, use7=True, use9=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_mrf79_k3      = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=True , mrf_replace=False, use7=True, use9=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_mrf57_k3      = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=True , mrf_replace=False, use5=True, use7=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_mrf35_k3      = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=True , mrf_replace=False, use3=True, use5=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
########################################################### 4
justG_mrf_replace7  = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=False, mrf_replace=True, use7=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_mrf_replace5  = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=False, mrf_replace=True, use5=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_mrf_replace3  = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=False, mrf_replace=True, use3=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
########################################################### 5
justG_mrf_replace79 = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=False, mrf_replace=True, use7=True, use9=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_mrf_replace75 = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=False, mrf_replace=True, use7=True, use5=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_mrf_replace35 = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=False, mrf_replace=True, use3=True, use5=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
########################################################### 2c
justG_mrf135_k3     = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=True , mrf_replace=False, use1=True, use3=True, use5=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_mrf357_k3     = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=True , mrf_replace=False, use3=True, use5=True, use7=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justG_mrf3579_k3    = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=True , mrf_replace=False, use3=True, use5=True, use7=True, use9=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)

rect_mrf35_Gk3_DnoC_k4     = KModel_builder().set_model_name(MODEL_NAME.rect ).use_rect2_mrf(first_k3=True , mrf_replace=False, use3=True, use5=True, D_first_concat=False, D_kernel_size=4).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
rect_mrf135_Gk3_DnoC_k4    = KModel_builder().set_model_name(MODEL_NAME.rect ).use_rect2_mrf(first_k3=True , mrf_replace=False, use1=True, use3=True, use5=True, D_first_concat=False, D_kernel_size=4).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
rect_mrf357_Gk3_DnoC_k4    = KModel_builder().set_model_name(MODEL_NAME.rect ).use_rect2_mrf(first_k3=True , mrf_replace=False, use3=True, use5=True, use7=True, D_first_concat=False, D_kernel_size=4).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
rect_mrf3579_Gk3_DnoC_k4   = KModel_builder().set_model_name(MODEL_NAME.rect ).use_rect2_mrf(first_k3=True , mrf_replace=False, use3=True, use5=True, use7=True, use9=True, D_first_concat=False, D_kernel_size=4).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
########################################################### 9a
...
########################################################### 11
justG_fk3_no_res             = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG(first_k3=True, use_res_learning=False).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)  ### 127.51
...
justG_fk3_no_res_mrf357      = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=True, mrf_replace=False, use_res_learning=False, use3=True, use5=True, use7=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)   ### 128.246
########################################################### 12
Gk3_resb00  = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG(first_k3=True, use_res_learning=True, resb_num=0).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)   ### 127.48
Gk3_resb01  = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG(first_k3=True, use_res_learning=True, resb_num=1).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)   ### 127.35
Gk3_resb03  = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG(first_k3=True, use_res_learning=True, resb_num=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)   ### 127.55
Gk3_resb05  = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG(first_k3=True, use_res_learning=True, resb_num=5).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)   ### 128.246
Gk3_resb07  = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG(first_k3=True, use_res_learning=True, resb_num=7).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)   ### 127.28
Gk3_resb09  = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG(first_k3=True, use_res_learning=True, resb_num=9).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)   ### 127.51
Gk3_resb11  = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG(first_k3=True, use_res_learning=True, resb_num=11).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)   ### 127.51
Gk3_resb15  = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG(first_k3=True, use_res_learning=True, resb_num=15).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)   ### 127.28
Gk3_resb20  = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG(first_k3=True, use_res_learning=True, resb_num=20).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)   ### 127.51

########################################################### 13 加coord_conv試試看
justGk3_coord_conv        = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG    (first_k3=True, coord_conv=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
justGk3_mrf357_coord_conv = KModel_builder().set_model_name(MODEL_NAME.justG ).use_justG_mrf(first_k3=True, coord_conv=True, mrf_replace=False, use3=True, use5=True, use7=True).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
...
###############################################################################################################################################################################################
########################################################### 15 用 resblock 來試試看
flow_rect_fk3_ch64_tfIN_resb_ok9 = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect(first_k3=True, hid_ch=64, true_IN=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)

flow_rect_7_level_fk7 = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=7, hid_ch=64, depth_level=7, true_IN=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)

flow_rect_2_level_fk3 = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=3, hid_ch=64, depth_level=2, true_IN=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
flow_rect_3_level_fk3 = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=3, hid_ch=64, depth_level=3, true_IN=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
flow_rect_4_level_fk3 = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=3, hid_ch=64, depth_level=4, true_IN=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
flow_rect_5_level_fk3 = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=3, hid_ch=64, depth_level=5, true_IN=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
flow_rect_6_level_fk3 = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=3, hid_ch=64, depth_level=6, true_IN=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
flow_rect_7_level_fk3 = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=3, hid_ch=64, depth_level=7, true_IN=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)

flow_rect_2_level_fk3_ReLU = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=3, hid_ch=64, depth_level=2, true_IN=True, use_ReLU=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
flow_rect_3_level_fk3_ReLU = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=3, hid_ch=64, depth_level=3, true_IN=True, use_ReLU=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
flow_rect_4_level_fk3_ReLU = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=3, hid_ch=64, depth_level=4, true_IN=True, use_ReLU=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
flow_rect_5_level_fk3_ReLU = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=3, hid_ch=64, depth_level=5, true_IN=True, use_ReLU=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
flow_rect_6_level_fk3_ReLU = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=3, hid_ch=64, depth_level=6, true_IN=True, use_ReLU=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
flow_rect_7_level_fk3_ReLU = KModel_builder().set_model_name(MODEL_NAME.flow_rect).use_flow_rect_7_level(first_k=3, hid_ch=64, depth_level=7, true_IN=True, use_ReLU=True, use_res_learning=True, resb_num=9, out_ch=3).set_train_step(train_step_pure_G_I_to_F_or_W_or_R)
