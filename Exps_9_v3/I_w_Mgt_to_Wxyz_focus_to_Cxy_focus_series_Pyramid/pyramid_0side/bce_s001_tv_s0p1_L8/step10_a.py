...
### Exp_builder
import Exps_8_v3.I_w_Mgt_to_Wx_Wy_Wz_focus_Gk3_no_pad.pyramid_0side.bce_s001_tv_s0p1_L8.step10_a as I_to_Wxyz_exp_builder
...
#############################################################
ch032_0side = Exp_builder().set_basic("train_run_final_see", use_db_obj, ch032_pyramid_0side, use_loss_obj, exp_dir=exp_dir, code_exe_path=code_exe_path, describe_end=ch032_pyramid_0side.kong_model.model_describe) .set_train_args(epochs= 60).set_train_in_gt_use_range(use_in_range=Range(0, 1), use_gt_range=Range(0, 1)).set_multi_model_reload_exp_builders_dict(I_to_Wx_Wy_Wz=I_to_Wxyz_exp_builder.ch032_0side, W_to_Cx_Cy=Reload_from_which_Exp).set_result_name(result_name="0side-no_time")  #.change_result_name_v3_to_v4_Remove_db_name(run_change=True, print_msg=True)
#############################################################
