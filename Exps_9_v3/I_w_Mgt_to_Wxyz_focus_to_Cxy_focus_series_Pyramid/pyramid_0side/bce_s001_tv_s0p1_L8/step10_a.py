...
#############################################################
ch032_0side = Exp_builder().set_basic("train_run_final_see", use_db_obj, ch032_pyramid_0side, use_loss_obj, exp_dir=exp_dir, code_exe_path=code_exe_path, describe_end=ch032_pyramid_0side.kong_model.model_describe) .set_train_args(epochs= 60, exp_bn_see_arg=None).set_train_in_gt_use_range(use_in_range=Range(0, 1), use_gt_range=Range(0, 1)).set_multi_model_reload_exp_builders_dict(I_to_Wx_Wy_Wz=I_to_Wxyz_exp_builder.ch032_0side, W_to_Cx_Cy=Reload_from_which_Exp).set_result_name(result_name="ch032-0side-no_time")
#############################################################
