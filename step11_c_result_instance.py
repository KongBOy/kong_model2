...
os_book_justG_bigger_wrong = Result_builder().set_by_result_name(dir4+"/type7b_h500_w332_real_os_book-20200601_022935-just_G-1532data_bigger_wrong"     ).set_ana_plot_title("justG_mae3_bigger_wrong").build()
...
os_book_1532_justG       = copy.deepcopy(os_book_just_G_mae3);  os_book_1532_justG.ana_plot_title = "1532_justG"
...
os_book_GD_first_k3       = Result_builder().set_by_result_name( dir7 + "/type7b_h500_w332_real_os_book-20200622_205606-rect-1532data_rect_firstk3_127.28_ep628"   ).set_ana_plot_title("GD_first_k3").build()
os_book_G_first_k7       = copy.deepcopy(os_book_just_G_mae3);  os_book_G_first_k7.ana_plot_title = "G_first_k7"
os_book_G_first_k3      = Result_builder().set_by_result_name( dir7 + "/type7b_h500_w332_real_os_book-20200622_205312-just_G-1532data_justG_firstk3_127.48_to127.246ep467" ).set_ana_plot_title("G_first_k3").build()
...
dir8b = "5_8b_G_mrf"
os_book_G_no_mrf = copy.deepcopy(os_book_just_G_mae3);  os_book_G_no_mrf.ana_plot_title = "no_mrf"
os_book_G_mrf_7         = Result_builder().set_by_result_name( dir8b + "/type7b_h500_w332_real_os_book-20200623_191110-just_G-1532data_justG_mrf_7_127.35_to128.245ep112"         ).set_ana_plot_title("mrf_7").build()
os_book_G_mrf_79        = Result_builder().set_by_result_name( dir8b + "/type7b_h500_w332_real_os_book-20200624_002925-just_G-1532data_justG_mrf_79ep122"        ).set_ana_plot_title("mrf_79").build()
os_book_G_mrf_replace7  = Result_builder().set_by_result_name( dir8b + "/type7b_h500_w332_real_os_book-20200622_214400-justG_mrf_replace7_127.48ep234"  ).set_ana_plot_title("mrf_replace7").build()
os_book_G_mrf_replace79 = Result_builder().set_by_result_name( dir8b + "/type7b_h500_w332_real_os_book-20200623_210009-just_G-1532data_justG_replace79_127.51ep170" ).set_ana_plot_title("mrf_replace79").build()
