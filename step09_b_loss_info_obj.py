...
class Loss_info_init_builder:
    ...
    def build(self):
        ...
        elif(self.loss_info_obj.loss_type == "bce+mae_sobel"): return self.build_bce_and_sobel_mae_loss_fun_and_containor()
...
class Loss_info_G_loss_builder(Loss_info_init_builder):
    ...
    def build_bce_and_sobel_mae_loss_fun_and_containor(self):
        ...
        self.loss_info_obj.loss_funs_dict["mask_Sobel_MAE"]        = sobel_mae_loss
        self.loss_info_obj.loss_containors["mask_bce_loss" ]       = tf.keras.metrics.Mean(name='mask_bce_loss', dtype=tf.float32)
        self.loss_info_obj.loss_containors["mask_sobel_MAE_loss" ] = tf.keras.metrics.Mean(name='mask_sobel_MAE_loss', dtype=tf.float32)
...
G_bce_sobel_loss_info_builder   = Loss_info_builder().set_loss_type("bce+mae_sobel")  #.build_gan_loss().build_gan_loss_containors()
