...
if(__name__ == "__main__"):
    ...
    cv2.imwrite(Data_Access_Dir + "step2_flow_build/map1.jpg", map1.astype(np.uint8))  ### cv2用方法一存完會變黑色的，因為方法一的顏色是plt自動填的！
    cv2.imwrite(Data_Access_Dir + "step2_flow_build/map2.png", map2)                   ### cv2存沒問題！
