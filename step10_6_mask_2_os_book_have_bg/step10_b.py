...
sb.run(same_command + [f"mask_h_bg_ch032_4l_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_h_bg_ch032_5l_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_h_bg_ch032_6l_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_h_bg_ch032_7l_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(same_command + [f"mask_h_bg_ch032_8l_sig_bce_ep060.{run}"])  ### 127.35跑
### 3. no-concat
