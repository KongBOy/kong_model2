...
### 建立給 unet 用的 pad2000-512to256，但先不要執行喔！因為目前用的是手動複製的，然後忘記當初怎麼複製的ˊ口ˋ 咪挺完看能不能就先 生成新的DB然後再改囉！
# build_datasets(build_dir_name="pad2000-512to256",
...
### 建立給 unet+rect2 用的 rect2_2000
# build_datasets(build_dir_name= "rect2_2000",
