...
from step08_b_use_G_generate_0_util import Value_Range_Postprocess_to_01, WcM_01_visual_op, C_01_concat_with_M_to_F_and_get_F_visual
...
def W_w_M_Gen_Cx_Cy_see(model_obj, phase, index, in_WM, in_WM_pre, Fgt, Fgt_pre, rec_hope=None, exp_obj=None, training=True, see_reset_init=True, postprocess=False, npz_save=False, add_loss=False, bgr2rgb=True):
    ...
    Mgt = Fgt[0, ..., 0:1].numpy()
    F,   F_visual,   Cx_visual,   Cy_visual   = C_01_concat_with_M_to_F_and_get_F_visual(C, Mgt)
    Fgt, Fgt_visual, Cxgt_visual, Cygt_visual = C_01_concat_with_M_to_F_and_get_F_visual(Cgt, Mgt)
