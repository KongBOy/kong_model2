...
block1_mask_L2345678 = [
    [
        ...
        mae_block1.L2_ch004.build().result_obj,
        mae_block1.L2_ch002.build().result_obj,
        mae_block1.L2_ch001.build().result_obj],
    [
    ...
    [
        mae_block1.L6_ch128_limit.build().result_obj,
    ...
    [
        mae_block1.L7_ch128_limit.build().result_obj,
        mae_block1.L7_ch064_limit.build().result_obj,
    ...
    [
        mae_block1.L8_ch128_limit.build().result_obj,
        mae_block1.L8_ch064_limit.build().result_obj,
        mae_block1.L8_ch032_limit.build().result_obj,
