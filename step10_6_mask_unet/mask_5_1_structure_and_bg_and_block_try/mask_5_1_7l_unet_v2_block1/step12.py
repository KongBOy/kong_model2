...
if(__name__ == "__main__"):
    ...
    #################################################################################################################################################################################################################
    ana_name = "1_ch-1_row"
    mask_L7_ch_analyze = Col_results_analyzer(ana_describe=f"0_{ana_dir}/ana_{ana_name}",
                                              ana_what="mask",
    ...
    ############################################
    ana_name = "1_ch-2_row"
    mask_layer_analyze = Row_col_results_analyzer(ana_describe=f"0_{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
