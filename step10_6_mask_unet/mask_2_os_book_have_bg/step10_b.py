...
### 3. no-concat
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_7l_2to2noC_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_7l_2to3noC_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_7l_2to4noC_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_7l_2to5noC_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_7l_2to6noC_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_7l_2to7noC_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_7l_2to8noC_sig_bce_ep060.{run}"])  ### 127.35跑
### 4. skip use add
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_2l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_3l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_4l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_5l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_6l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_7l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
sb.run(cmd_python_step10_a + [f"mask_h_bg_ch032_8l_skipAdd_sig_bce_ep060.{run}"])  ### 127.35跑
