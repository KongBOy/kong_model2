...
if(__name__ == "__main__"):
    ...
    from step11_7b_tv_sobel import  *
    #############################################################################################################################################################################################################
    ...
    #################################################################################################################################################################################################################
    ana_name = "step20"
    step20_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
                                                  row_col_results=mask_ch032_tv_s020_030_sobel_k5_s001_140,
    ...
    #################################################################################################################################################################################################################
    ana_name = "step40"
    step40_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
                                                  row_col_results=mask_ch032_tv_s020_030_sobel_k5_s001_140[::2, ::2],
                                                  show_in_img=False, show_gt_img=False, bgr2rgb=True, add_loss=False)\
                                    .analyze_row_col_results_all_single_see(single_see_multiprocess=True, single_see_core_amount=6)
