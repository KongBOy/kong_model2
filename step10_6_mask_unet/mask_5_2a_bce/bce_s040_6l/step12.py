...
if(__name__ == "__main__"):
    ...
    ch_analyze = Row_col_results_analyzer(ana_describe=f"0_{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
                                                  row_col_results=[mask_L6_bce_s40_ch[:4],
                                                                   mask_L6_bce_s40_ch[4:]], show_in_img=False, show_gt_img=False, bgr2rgb=True, add_loss=False)\
    ...
    ep_analyze = Row_col_results_analyzer(ana_describe=f"0_{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
                                                  row_col_results=[mask_L6_bce_s40_ep[:8],
                                                                   mask_L6_bce_s40_ep[8:]], show_in_img=False, show_gt_img=False, bgr2rgb=True, add_loss=False)\
                                            # .analyze_row_col_results_all_single_see(single_see_multiprocess=True, single_see_core_amount=6)
    ############################################
    ana_name = "3_noC"
