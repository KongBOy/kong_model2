...
# sb.run(cmd_python_step10_a + [f"L4_ch032_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch032_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch032_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch032_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch032_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch032_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L4_ch016_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch016_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch016_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch016_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch016_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch016_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L4_ch008_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch008_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch008_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch008_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch008_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch008_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L4_ch004_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch004_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch004_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch004_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch004_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch004_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L4_ch002_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch002_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch002_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch002_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch002_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch002_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L4_ch001_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch001_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch001_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch001_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch001_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L4_ch001_sig_ep060_bce_s100.{run}"])

#### 5l ############################################################################################
# sb.run(cmd_python_step10_a + [f"L5_ch032_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch032_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch032_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch032_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch032_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch032_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L5_ch016_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch016_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch016_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch016_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch016_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch016_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L5_ch008_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch008_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch008_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch008_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch008_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch008_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L5_ch004_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch004_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch004_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch004_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch004_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch004_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L5_ch002_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch002_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch002_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch002_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch002_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch002_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L5_ch001_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch001_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch001_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch001_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch001_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L5_ch001_sig_ep060_bce_s100.{run}"])
...
# sb.run(cmd_python_step10_a + [f"L6_ch008_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch008_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch008_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch008_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch008_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch008_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L6_ch004_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch004_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch004_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch004_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch004_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch004_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L6_ch002_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch002_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch002_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch002_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch002_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch002_sig_ep060_bce_s100.{run}"])

# sb.run(cmd_python_step10_a + [f"L6_ch001_sig_ep060_bce_s001.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch001_sig_ep060_bce_s020.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch001_sig_ep060_bce_s040.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch001_sig_ep060_bce_s060.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch001_sig_ep060_bce_s080.{run}"])
# sb.run(cmd_python_step10_a + [f"L6_ch001_sig_ep060_bce_s100.{run}"])
