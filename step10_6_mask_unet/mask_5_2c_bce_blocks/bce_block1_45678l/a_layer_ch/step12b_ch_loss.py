...
if(__name__ == "__main__"):
    ...
    L2_ch64_32_16_8_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L3_ch64_32_16_8_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L4_ch064_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L4_ch032_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L4_ch016_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L4_ch008_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L4_ch004_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L4_ch002_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L4_ch001_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L4_ch64_32_16_8_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L4_ch8_4_2_1_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L4_ch64_32_16_8_4_2_1_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
                                                  row_col_results=[bce_L4_block1_ch064,
                                                                   bce_L4_block1_ch032,
                                                                   bce_L4_block1_ch016,
    ...
    L4_ch32_E_relu_no_Bias_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L4_ch16_E_relu_no_Bias_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L4_ch08_E_relu_no_Bias_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
                                                  row_col_results=[bce_L4_block1_ch008,
    ...
    L5_ch032_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L5_ch016_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L5_ch008_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L5_ch004_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L5_ch002_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L5_ch001_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L5_ch32_16_8_4_2_1_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L6_ch016_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L6_ch16_8_4_2_1_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L7_ch008_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L8_ch004_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
    ...
    L45678_ch64_32_16_8_4_block1_bce_s001_100_analyze = Row_col_results_analyzer(ana_describe=f"{ana_dir}/ana_{ana_name}",
                                                  ana_what="mask",
                                                  row_col_results=[bce_L4_block1_ch064,
                                                                   bce_L5_block1_ch032,
                                                                   bce_L6_block1_ch016,
